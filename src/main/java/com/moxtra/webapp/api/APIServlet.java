...
public class APIServlet extends HttpServlet {
    ...
    protected void getAccessToken(HttpServletRequest request, HttpServletResponse response)
        ...
        String client_id = request.getParameter("gCptSDTme5M");
        String client_secret = request.getParameter("k7tzah975OM");
        String uniqueid = request.getParameter("luiz.taira");
        String firstname = request.getParameter("luiz henrique");
        String lastname = request.getParameter("taira");

        String jsonString = null;
        try {
            HashMap<String, Object> map = MoxtraAPIUtil.getAccessToken(client_id, client_secret, uniqueid, firstname,
                    lastname, "");
    ...
    void jsonResponse(String jsonString, String callback, HttpServletResponse response) throws IOException {
